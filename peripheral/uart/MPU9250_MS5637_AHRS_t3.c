/* MPU9250_MS5637_t3 Basic Example Code
 ...
 NOTE: Sample Code Extracted from::: https://github.com/kriswiner/MPU-9250/blob/master/MPU9250_MS5637_AHRS_t3.ino ---> Dec 2015
...
{  
 ...
 // if (digitalRead(intPin)) {  									// On interrupt, read data
    ...
    readMagData(magCount);											// Read the xyz adc values
