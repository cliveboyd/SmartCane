...
struct int_param_s {
    ...
    void *arg;
#else									// CLIVE Added to drop Error
	unsigned long pin;					// CLIVE Added to drop Error
    void (*cb)(volatile void*);			// CLIVE Added to drop Error
    void *arg;							// CLIVE Added to drop Error
#endif
};
