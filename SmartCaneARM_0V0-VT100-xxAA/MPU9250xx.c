...
bool MPU9250xx::writeRegister(const uint8_t register_addr, const uint8_t value) {
...
bool MPU9250xx::writeMagRegister(const uint8_t register_addr, const uint8_t value) {
    //send write call to sensor address
    //send register address to sensor
    //send value to register
    bool write_status = 0;
...
bool MPU9250xx::writeRegisters(const uint8_t msb_register, const uint8_t msb_value, const uint8_t lsb_register, const uint8_t lsb_value) { 
    //send write call to sensor address
    //send register address to sensor
    //send value to register
...
bool MPU9250xx::writeMaskedRegister(const uint8_t register_addr, const uint8_t mask, const uint8_t value) {
    uint8_t masked_value = (mask & value); 							/*	There has to be an easier way to do this.... 
																		I know, I know, shut up, I know it's that, 
																		I'll get around to it when I can ok? */
    return writeRegister(register_addr, masked_value);
    //every reference to this is wrong (also)!! fix them!
}

uint8_t MPU9250xx::readRegister(const uint8_t register_addr) {
...
uint8_t MPU9250xx::readMagRegister(const uint8_t register_addr) {
    //call sensor by address
    //call registers
    uint8_t data = 0;
...
uint16_t MPU9250xx::readRegisters(const uint8_t msb_register, const uint8_t lsb_register) {
...
uint8_t MPU9250xx::readMaskedRegister(const uint8_t register_addr, const uint8_t mask) {
 ...
 */
void MPU9250xx::initialize(void) {
    Wire.begin(); 
 ...
 */
uint8_t MPU9250xx::getAuxVDDIOLevel(void) {
    return 0;
 ...
 */
bool MPU9250xx::setAuxVDDIOLevel(const uint8_t level) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getRate(void) {
 ...
 * @see MPU9250_SMPLRT_DIV
 */
bool MPU9250xx::setRate(const uint8_t rate) {
 ...
 */
uint8_t MPU9250xx::getExternalFrameSync(void) {
 ...
 */
bool MPU9250xx::setExternalFrameSync(const uint8_t sync) {
 ...
 */
uint8_t MPU9250xx::getDLPFMode(void) {
 ...
 * @see MPU9250_DLPF_CFG_MASK
 */
bool MPU9250xx::setDLPFMode(const uint8_t mode) {
    if(mode > 7) {
        return 0;
    }
 ...
 */
uint8_t MPU9250xx::getFullScaleGyroRange(void) {
 ...
 * @see MPU9250_GYRO_FS_SEL_MASK
 */
bool MPU9250xx::setFullScaleGyroRange(const uint8_t range) {
 ...
 */
bool MPU9250xx::getAccelXSelfTest(void) {
 ...
 * @see MPU9250_SELF_TEST_X_ACCEL
 */
bool MPU9250xx::setAccelXSelfTest(const uint8_t enabled) {
 ...
 */
bool MPU9250xx::getAccelYSelfTest(void) {
 ...
 * @see MPU9250_SELF_TEST_Y_ACCEL
 */
bool MPU9250xx::setAccelYSelfTest(const uint8_t enabled) {
 ...
 */
bool MPU9250xx::getAccelZSelfTest(void) {
 ...
 * @see MPU9250_SELF_TEST_Z_ACCEL
 */
bool MPU9250xx::setAccelZSelfTest(const uint8_t enabled) {
 ...
 */
uint8_t MPU9250xx::getFullScaleAccelRange(void) {
 ...
 */
bool MPU9250xx::setFullScaleAccelRange(const uint8_t range) {
    if(range < 3){
        return 0;
    } else {
 ...
 */
uint8_t MPU9250xx::getDHPFMode(void) {
    return 0;
 ...
 * @see MPU9250_RA_ACCEL_CONFIG
 */
bool MPU9250xx::setDHPFMode(const uint8_t bandwidth) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getFreefallDetectionThreshold(void) {
    return 0;
 ...
 * @see MPU9250_RA_FF_THR
 */
bool MPU9250xx::setFreefallDetectionThreshold(const uint8_t threshold) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getFreefallDetectionDuration(void) {
    return 0;
 ...
 * @see MPU9250_RA_FF_DUR
 */
bool MPU9250xx::setFreefallDetectionDuration(const uint8_t duration) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getMotionDetectionThreshold(void) {
    return 0;
 ...
 * @see MPU9250_RA_MOT_THR
 */
bool MPU9250xx::setMotionDetectionThreshold(const uint8_t threshold) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getMotionDetectionDuration(void) {
    return 0;
 ...
 * @see MPU9250_RA_MOT_DUR
 */
bool MPU9250xx::setMotionDetectionDuration(const uint8_t duration) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getZeroMotionDetectionThreshold(void) {
    return 0;
 ...
 * @see MPU9250_RA_ZRMOT_THR
 */
bool MPU9250xx::setZeroMotionDetectionThreshold(const uint8_t threshold) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getZeroMotionDetectionDuration(void) {
    return 0;
 ...
 * @see MPU9250_RA_ZRMOT_DUR
 */
bool MPU9250xx::setZeroMotionDetectionDuration(const uint8_t duration) {
    return 0;
 ...
 */
bool MPU9250xx::getTempFIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setTempFIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getXGyroFIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setXGyroFIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getYGyroFIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setYGyroFIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getZGyroFIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setZGyroFIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getAccelFIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setAccelFIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getSlave2FIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setSlave2FIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getSlave1FIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setSlave1FIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::getSlave0FIFOEnabled(void) {
 ...
 * @see MPU9250_RA_FIFO_EN
 */
bool MPU9250xx::setSlave0FIFOEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getMultiMasterEnabled(void) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
bool MPU9250xx::setMultiMasterEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
bool MPU9250xx::getWaitForExternalSensorEnabled(void) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
bool MPU9250xx::setWaitForExternalSensorEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getSlave3FIFOEnabled(void) {
 ...
 * @see MPU9250_RA_MST_CTRL
 */
bool MPU9250xx::setSlave3FIFOEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
bool MPU9250xx::getSlaveReadWriteTransitionEnabled(void) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
bool MPU9250xx::setSlaveReadWriteTransitionEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
uint8_t MPU9250xx::getMasterClockSpeed(void) {
 ...
 * @see MPU9250_RA_I2C_MST_CTRL
 */
bool MPU9250xx::setMasterClockSpeed(const uint8_t speed) {
    if(speed > 15) {
        return 0;
    }
 ...
 */
uint8_t MPU9250xx::getSlaveAddress(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_ADDR
 */
bool MPU9250xx::setSlaveAddress(uint8_t num, uint8_t address) {
    if(num > 3) {
        return 0;
    }
 ...
 */
uint8_t MPU9250xx::getSlaveRegister(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_REG
 */
bool MPU9250xx::setSlaveRegister(uint8_t num, uint8_t reg) {
    if(num > 3) {
        return 0;
    }
 ...
 */
bool MPU9250xx::getSlaveEnabled(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
bool MPU9250xx::setSlaveEnabled(uint8_t num, const bool enabled) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
bool MPU9250xx::getSlaveWordByteSwap(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 */
bool MPU9250xx::setSlaveWordByteSwap(uint8_t num, const bool enabled) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_I2C_SLV0_CTRL
 */
bool MPU9250xx::getSlaveWriteMode(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
bool MPU9250xx::setSlaveWriteMode(uint8_t num, const bool mode) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
bool MPU9250xx::getSlaveWordGroupOffset(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
bool MPU9250xx::setSlaveWordGroupOffset(uint8_t num, const bool enabled) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
uint8_t MPU9250xx::getSlaveDataLength(uint8_t num) {
    if(num > 3) {
        return 0;
    }
 ...
 * @see MPU9250_RA_I2C_SLV0_CTRL
 */
bool MPU9250xx::setSlaveDataLength(uint8_t num, const uint8_t length) {
    if(num > 3) {
        return false;
    }
 ...
 */
uint8_t MPU9250xx::getSlave4Address(void) {
 ...
 * @see MPU9250_RA_I2C_SLV4_ADDR
 */
bool MPU9250xx::setSlave4Address(const uint8_t address) {
 ...
 */
uint8_t MPU9250xx::getSlave4Register(void) {
 ...
 * @see MPU9250_RA_I2C_SLV4_REG
 */
bool MPU9250xx::setSlave4Register(const uint8_t reg) {
 ...
 */
bool MPU9250xx::setSlave4OutputByte(const uint8_t data) {
 ...
 */
bool MPU9250xx::getSlave4Enabled(void) {
 ...
 */
bool MPU9250xx::setSlave4Enabled(const bool enabled) {
 ...
 * @see MPU9250_RA_I2C_SLV4_CTRL
 */
bool MPU9250xx::getSlave4InterruptEnabled(void) {
 ...
 * @see MPU9250_I2C_SLV4_CTRL
 */
bool MPU9250xx::setSlave4InterruptEnabled(const bool enabled) {
 ...
 * @see MPU9250_RA_I2C_SLV4_CTRL
 */
bool MPU9250xx::getSlave4WriteMode(void) {
 ...
 * @see MPU9250_I2C_SLV4_CTRL
 */
bool MPU9250xx::setSlave4WriteMode(const bool mode) {
 ...
 * @see MPU9250_RA_I2C_SLV4_CTRL
 */
uint8_t MPU9250xx::getSlave4MasterDelay(void) {
 ...
 * @see MPU9250_RA_I2C_SLV4_CTRL
 */
bool MPU9250xx::setSlave4MasterDelay(const uint8_t delay) {
 ...
 */
uint8_t MPU9250xx::getSlate4InputByte(void) {
 ...
 */
bool MPU9250xx::getPassthroughStatus(void) {
 ...
 * @see MPU9250_I2C_MST_STATUS
 */
bool MPU9250xx::getSlave4IsDone(void) {
 ...
 * @see MPU9250_I2C_MST_STATUS
 */
bool MPU9250xx::getLostArbitration(void) {
 ...
 */
bool MPU9250xx::getSlave4Nack(void) {
 ...
 * @see MPU9250_RA_I2C_MST_STATUS
 */
bool MPU9250xx::getSlave3Nack(void) {
 ...
 * @see MPU9250_RA_I2C_MST_STATUS
 */
bool MPU9250xx::getSlave2Nack(void) {
 ...
 * @see MPU9250_RA_I2C_MST_STATUS
 */
bool MPU9250xx::getSlave1Nack(void) {
 ...
 * @see MPU9250_RA_I2C_MST_STATUS
 */
bool MPU9250xx::getSlave0Nack(void) {
 ...
 */
bool MPU9250xx::getInterruptMode(void) {
 ...
 * @see MPU9250_ACTL_MASK
 */
bool MPU9250xx::setInterruptMode(const bool mode) {
 ...
 */
bool MPU9250xx::getInterruptDrive(void) {
 ...
 * @see MPU9250_OPEN_MASK
 */
bool MPU9250xx::setInterruptDrive(const bool drive) {
 ...
 */
bool MPU9250xx::getInterruptLatch(void) {
 ...
 * @see MPU9250_LATCH_INT_EN_MASK
 */
bool MPU9250xx::setInterruptLatch(const bool latch) {
 ...
 */
bool MPU9250xx::getInterruptLatchClear(void) {
 ...
 * @see MPU9250_INT_ANYRD_2CLEAR_MASK
 */
bool MPU9250xx::setInterruptLatchClear(const bool clear) {
 ...
 */
bool MPU9250xx::getFSyncInterruptLevel(void) {
 ...
 * @see MPU9250_FSYNC_INT_MODE_EN_MASK
 */
bool MPU9250xx::setFSyncInterruptLevel(const bool level) {
 ...
 */
bool MPU9250xx::getFSyncInterruptEnabled(void) {
 ...
 * @see MPU9250_FSYNC_INT_EN_MASK
 */
bool MPU9250xx::setFSyncInterruptEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getI2CBypassEnabled(void) {
 ...
 * @see MPU9250_BYPASS_EN_MASK
 */
bool MPU9250xx::setI2CBypassEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getClockOutputEnabled(void) {
    return 0;
 ...
 * @see MPU9250_INTCFG_CLKOUT_EN_BIT
 */
bool MPU9250xx::setClockOutputEnabled(const bool enabled) {
    return 0;
 ...
 **/
uint8_t MPU9250xx::getIntEnabled(void) {
 ...
 * @see MPU9250_INTERRUPT_FF_BIT
 **/
bool MPU9250xx::setIntEnabled(const uint8_t enabled) {
 ...
 * @see MPU9250_INTERRUPT_FF_BIT
 **/
bool MPU9250xx::getIntFreefallEnabled(void) {
    return 0;
 ...
 * @see MPU9250_INTERRUPT_FF_BIT
 **/
bool MPU9250xx::setIntFreefallEnabled(const bool enabled) {
    return 0;
 ...
 **/
bool MPU9250xx::getIntMotionEnabled(void) {
 ...
 * @see MPU9250_INTERRUPT_MOT_BIT
 **/
bool MPU9250xx::setIntMotionEnabled(const bool enabled) {
    return 0;
 ...
 **/
bool MPU9250xx::getIntZeroMotionEnabled(void) {
    return 0;
 ...
 * @see MPU9250_INTERRUPT_ZMOT_BIT
 **/
bool MPU9250xx::setIntZeroMotionEnabled(const bool enabled) {
    return 0;
 ...
 **/
bool MPU9250xx::getIntFIFOBufferOverflowEnabled(void) {
 ...
 * @see MPU9250_FIFO_OFLOW_EN_MASK
 **/
bool MPU9250xx::setIntFIFOBufferOverflowEnabled(const bool enabled) {
 ...
 **/
bool MPU9250xx::getIntI2CMasterEnabled(void) {
 ...
 * @see MPU9250_I2C_MST_EN_MASK
 **/
bool MPU9250xx::setIntI2CMasterEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getIntDataReadyEnabled(void) {
    return 0;
 ...
 * @see MPU9250_INTERRUPT_DATA_RDY_BIT
 */
bool MPU9250xx::setIntDataReadyEnabled(const bool enabled) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getIntStatus(void) {
 ...
 * @see MPU9250_INTERRUPT_FF_BIT
 */
bool MPU9250xx::getIntFreefallStatus(void) {
    return 0;
 ...
 * @see MPU9250_INTERRUPT_MOT_BIT
 */
bool MPU9250xx::getIntMotionStatus(void) {
    return 0;
 ...
 * @see MPU9250_INTERRUPT_ZMOT_BIT
 */
bool MPU9250xx::getIntZeroMotionStatus(void) {
    return 0;
 ...
 */
bool MPU9250xx::getIntFIFOBufferOverflowStatus(void) {
    return 0;
 ...
 */
bool MPU9250xx::getIntI2CMasterStatus(void) {
    return 0;
 ...
 * @see MPU9250_INTERRUPT_DATA_RDY_BIT
 */
bool MPU9250xx::getIntDataReadyStatus(void) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getExternalSensorByte(int position) {
 ...
 */
uint16_t MPU9250xx::getExternalSensorWord(int position) {
 ...
 * @see getExternalSensorByte()
 */
uint32_t MPU9250xx::getExternalSensorDWord(int position) {
 ...
 */
bool MPU9250xx::getXNegMotionDetected(void) {
    return 0;
 ...
 */
bool MPU9250xx::getXPosMotionDetected(void) {
    return 0;
 ...
 */
bool MPU9250xx::getYNegMotionDetected(void) {
    return 0;
 ...
 */
bool MPU9250xx::getYPosMotionDetected(void) {
    return 0;
 ...
 */
bool MPU9250xx::getZNegMotionDetected(void) {
    return 0;
 ...
 */
bool MPU9250xx::getZPosMotionDetected(void) {
    return 0;
 ...
 */
bool MPU9250xx::getZeroMotionDetected(void) {
 ...
 */
bool MPU9250xx::setSlaveOutputByte(uint8_t num, const uint8_t data) {
    if (num > 3) {
        return 0;
    }
 ...
 */
bool MPU9250xx::getExternalShadowDelayEnabled(void) {
 ...
 * @see MPU9250_DELAYCTRL_DELAY_ES_SHADOW_BIT
 */
bool MPU9250xx::setExternalShadowDelayEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getSlaveDelayEnabled(const uint8_t num) {
 ...
 * @see MPU9250_DELAYCTRL_I2C_SLV0_DLY_EN_BIT
 */
bool MPU9250xx::setSlaveDelayEnabled(const uint8_t num, const bool enabled) {
    if(num > 4) {
        return 0;
    }
 ...
 */
bool MPU9250xx::resetGyroscopePath(void) {
 ...
 */
bool MPU9250xx::resetAccelerometerPath(void) {
 ...
 */
bool MPU9250xx::resetTemperaturePath(void) {
 ...
 */
uint8_t MPU9250xx::getAccelerometerPowerOnDelay(void) {
    return 0;
 ...
 * @see MPU9250_DETECT_ACCEL_ON_DELAY_BIT
 */
bool MPU9250xx::setAccelerometerPowerOnDelay(const uint8_t delay) {
    return 0;
 ...
 */
uint8_t MPU9250xx::getFreefallDetectionCounterDecrement(void) {
    return 0;
 ...
 * @see MPU9250_DETECT_FF_COUNT_BIT
 */
bool MPU9250xx::setFreefallDetectionCounterDecrement(const uint8_t decrement) {
    return 0;
 ...
 *
 */
uint8_t MPU9250xx::getMotionDetectionCounterDecrement(void) {
    return 0;
 ...
 */
void MPU9250xx::setMotionDetectionCounterDecrement(const uint8_t decrement) {
 ...
 */
bool MPU9250xx::getFIFOEnabled(void) {
 ...
 * @see MPU9250_USERCTRL_FIFO_EN_BIT
 */
bool MPU9250xx::setFIFOEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::getI2CMasterModeEnabled(void) {
    uint8_t response = readMaskedRegister(MPU9250_USER_CTRL, MPU9250_I2C_MST_EN_MASK);
    return (response != 0);
}
 ...
 * @see MPU9250_USERCTRL_I2C_MST_EN_BIT
 */
bool MPU9250xx::setI2CMasterModeEnabled(const bool enabled) {
    return writeMaskedRegister(MPU9250_USER_CTRL, MPU9250_I2C_MST_EN_MASK, enabled);
}
 ...
 */
bool MPU9250xx::switchSPIEnabled(const bool enabled) {
 ...
 */
bool MPU9250xx::resetI2CMaster(void) {
 ...
 */
bool MPU9250xx::resetSensors(void) {
 ...
 */
bool MPU9250xx::getSleepEnabled(void) {
 ...
 */
bool MPU9250xx::setSleepEnabled(const bool enabled) {
    // Set X-axis accelerometer standby enabled status.
 ...
 */
bool MPU9250xx::getWakeCycleEnabled(void) {
 ...
 * @see MPU9250_CYCLE_MASK
 */
bool MPU9250xx::setWakeCycleEnabled(const bool enabled) {
    // Set X-axis accelerometer standby enabled status.
 ...
 */
uint8_t MPU9250xx::getClockSource(void) {
 ...
 * @see MPU9250_CLKSEL_MASK
 */
bool MPU9250xx::setClockSource(const uint8_t source) {
    if(source > 7) {
        return 0;
    }
 ...
 */
uint8_t MPU9250xx::getWakeFrequency(void) {
    return 0;
 ...
 * @see MPU9250_RA_PWR_MGMT_2
 */
bool MPU9250xx::setWakeFrequency(const uint8_t frequency) {
    return 0;
 ...
 */
bool MPU9250xx::getStandbyXAccelEnabled(void) {
    return 0;
 ...
 * @see MPU9250_PWR2_STBY_XA_BIT
 */
bool MPU9250xx::setStandbyXAccelEnabled(const bool enabled) {
    return 0;
 ...
 */
bool MPU9250xx::getStandbyYAccelEnabled(void) {
    return 0;
 ...
 * @see MPU9250_PWR2_STBY_YA_BIT
 */
bool MPU9250xx::setStandbyYAccelEnabled(const bool enabled) {
    return 0;
 ...
 */
bool MPU9250xx::getStandbyZAccelEnabled(void) {
    return 0;
 ...
 * @see MPU9250_PWR2_STBY_ZA_BIT
 */
bool MPU9250xx::setStandbyZAccelEnabled(const bool enabled) {
    return 0;
 ...
 */
bool MPU9250xx::getStandbyXGyroEnabled(void) {
    return 0;
 ...
 * @see MPU9250_PWR2_STBY_XG_BIT
 */
bool MPU9250xx::setStandbyXGyroEnabled(const bool enabled) {
    return 0;
 ...
 */
bool MPU9250xx::getStandbyYGyroEnabled(void) {
    return 0;
 ...
 * @see MPU9250_PWR2_STBY_YG_BIT
 */
bool MPU9250xx::setStandbyYGyroEnabled(const bool enabled) {
    return 0;
 ...
 */
bool MPU9250xx::getStandbyZGyroEnabled(void) {
    return 0;
 ...
 * @see MPU9250_PWR2_STBY_ZG_BIT
 */
bool MPU9250xx::setStandbyZGyroEnabled(const bool enabled) {
    return 0;
 ...
 */
uint16_t MPU9250xx::getFIFOCount(void) {
 ...
 */
uint8_t MPU9250xx::getFIFOByte(void) {
    return readRegister(MPU9250_FIFO_R_W);
}

//uint8_t MPU9250xx::getFIFOBytes(uint8_t *data, uint8_t length) {
 ...
 */
bool MPU9250xx::setFIFOByte(const uint8_t data) {
...
bool MPU9250xx::setIntPLLReadyEnabled(const bool enabled) {
    return 0;
...
bool MPU9250xx::getIntDMPEnabled(void) {
    return 0;
...
bool MPU9250xx::setIntDMPEnabled(const bool enabled) {
    return 0;
...
// DMP_INT_STATUS
bool MPU9250xx::getDMPInt5Status(void) {
    return 0;
...
bool MPU9250xx::getDMPInt4Status(void) {
    return 0;
...
bool MPU9250xx::getDMPInt3Status(void) {
    return 0;
...
bool MPU9250xx::getDMPInt2Status(void) {
    return 0;
...
bool MPU9250xx::getDMPInt1Status(void) {
    return 0;
...
bool MPU9250xx::getDMPInt0Status(void) {
    return 0;
...
bool MPU9250xx::getIntPLLReadyStatus(void) {
    return 0;
...
bool MPU9250xx::getIntDMPStatus(void) {
    return 0;
...
bool MPU9250xx::getDMPEnabled(void) {
    return 0;
...
bool MPU9250xx::setDMPEnabled(const bool enabled) {
    return 0;
...
// BANK_SEL register
bool MPU9250xx::setMemoryBank(uint8_t bank, const bool prefetchEnabled, const bool userBank) {
    bank &= 0x1F;
...
bool MPU9250xx::setMemoryStartAddress(const uint8_t address) {
    return 0;
    //return writeRegister(MPU9250_RA_MEM_START_ADDR, address);
}

// MEM_R_W register
uint8_t MPU9250xx::readMemoryByte(void) {
    return 0;
    //return readRegister(MPU9250_RA_MEM_R_W);
}

bool MPU9250xx::writeMemoryByte(uint8_t data) {
    return 0;
    //return writeRegister(MPU9250_RA_MEM_R_W, data);
}

void MPU9250xx::readMemoryBlock(uint8_t *data, uint16_t dataSize, uint8_t bank, uint8_t address) {
    //setMemoryBank(bank);
...
bool MPU9250xx::writeMemoryBlock(const uint8_t *data, uint16_t dataSize, uint8_t bank, uint8_t address, bool verify, bool useProgMem) {
    //setMemoryBank(bank);
    setMemoryStartAddress(address);
    uint8_t chunkSize;
...
bool MPU9250xx::writeProgMemoryBlock(const uint8_t *data, uint16_t dataSize, uint8_t bank, uint8_t address, bool verify) {
    return writeMemoryBlock(data, dataSize, bank, address, verify, true);
}

bool MPU9250xx::writeDMPConfigurationSet(const uint8_t *data, uint16_t dataSize, bool useProgMem) {
...
bool MPU9250xx::writeProgDMPConfigurationSet(const uint8_t *data, const uint16_t dataSize) {
    return writeDMPConfigurationSet(data, dataSize, true);
}

// DMP_CFG_1 register

uint8_t MPU9250xx::getDMPConfig1(void) {
    return 0;
    //return readRegister(MPU9250_RA_DMP_CFG_1);
}

bool MPU9250xx::setDMPConfig1(uint8_t config) {
    return 0;
...
uint8_t MPU9250xx::getDMPConfig2(void) {
    return 0;
    //return readRegister(MPU9250_RA_DMP_CFG_2);
}

bool MPU9250xx::setDMPConfig2(uint8_t config) {
    return 0;
    //return writeRegister(MPU9250_RA_DMP_CFG_2, config);
}

uint8_t MPU9250xx::getDeviceID(void) {
 ...
 */
bool MPU9250xx::testConnection(void) {
    return getDeviceID() == WHOAMI_DEFAULT_VAL;
}

void MPU9250xx::selectClock(uint8_t clock_type) {

}

//Accelerometer functions
bool MPU9250xx::enableAccelerometerAxis(const uint8_t axis) {
...
bool MPU9250xx::disableAccelerometerAxis(const uint8_t axis) {
    //arguments are : MPU9250_DISABLE_XA_MASK, MPU9250_DISABLE_YA_MASK, MPU9250_DISABLE_ZA_MASK
    //WARNING: this should be verified here
    return writeRegister(MPU9250_PWR_MGMT_2, axis);
}

bool MPU9250xx::enableAccelerometer(void) {
...
bool MPU9250xx::disableAccelerometer(void) {
    //WARNING: should read register value first and modify accordingly
    return writeRegister(MPU9250_PWR_MGMT_2, MPU9250_DISABLE_XYZA_MASK);
}

void MPU9250xx::getAccelerometerTestData(uint8_t ax, uint8_t ay, uint8_t az) {
 ...
 */
int16_t MPU9250xx::getAccelerationX(void) {
 ...
 */
int16_t MPU9250xx::getAccelerationY(void) {
 ...
 */
int16_t MPU9250xx::getAccelerationZ(void) {
 ...
 */
void MPU9250xx::getAcceleration(int16_t* ax, int16_t* ay, int16_t* az) {
    *ax = getAccelerationX();
    *ay = getAccelerationY();
    *az = getAccelerationZ();
}
...
bool MPU9250xx::enableGyroAxis(const uint8_t axis) {
...
bool MPU9250xx::disableGyroAxis(const uint8_t axis) {
    //arguments are : MPU9250_DISABLE_XG_MASK, MPU9250_DISABLE_YG_MASK, MPU9250_DISABLE_ZG_MASK
    //WARNING: this should be verified here
    return writeRegister(MPU9250_PWR_MGMT_2, axis);
}

bool MPU9250xx::enableGyro(void) {
    //WARNING: should read register value first and modify accordingly
    //WARNING: wrong register value
    return writeRegister(MPU9250_PWR_MGMT_2, MPU9250_DISABLE_XYZG_MASK);
}

bool MPU9250xx::disableGyro(void) {
    //WARNING: should read register value first and modify accordingly
    return writeRegister(MPU9250_PWR_MGMT_2, MPU9250_DISABLE_XYZG_MASK);
}

void MPU9250xx::getGyroTestData(uint8_t gx, uint8_t gy, uint8_t gz) {
        gx = readRegister(MPU9250_SELF_TEST_X_GYRO); 
        gy = readRegister(MPU9250_SELF_TEST_Y_GYRO); 
        gz = readRegister(MPU9250_SELF_TEST_Z_GYRO);
}

bool MPU9250xx::gyroXIsEnabled(void) {
    //WARNING: this should be verified here
    uint8_t status = readMaskedRegister(MPU9250_PWR_MGMT_2, MPU9250_DISABLE_ZG_MASK);
    return (status != 0);
}

bool MPU9250xx::gyroYIsEnabled(void) {
    //WARNING: this should be verified here
    uint8_t status = readMaskedRegister(MPU9250_PWR_MGMT_2, MPU9250_DISABLE_ZG_MASK);
    return (status != 0);
}

bool MPU9250xx::gyroZIsEnabled(void) {
    //WARNING: this should be verified here
    uint8_t status = readMaskedRegister(MPU9250_PWR_MGMT_2, MPU9250_DISABLE_ZG_MASK);
    return (status != 0);
}
 ...
 */
int16_t MPU9250xx::getRotationX(void) {
    if(gyroXIsEnabled()){
 ...
 */
int16_t MPU9250xx::getRotationY(void) {
    if(gyroYIsEnabled()){
 ...
 */
int16_t MPU9250xx::getRotationZ(void) {
    if(gyroZIsEnabled()){
...
void MPU9250xx::getRotation(int16_t* gx, int16_t* gy, int16_t* gz) {
    *gx = getRotationX();
    *gy = getRotationY();
    *gz = getRotationZ();
}

void MPU9250xx::getMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz) {
 ...
 */
void MPU9250xx::getMotion9(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz, int16_t* mx, int16_t* my, int16_t* mz) {
